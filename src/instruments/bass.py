...
class Bass(BaseInstrument):
    ...
    def generate_pattern(self, song_data: SongData, chord: str = None, style: str = None) -> List[Tuple[int, float, float, int]]:
        ...
        intro_patterns = [
            # Pattern 1: Root notes
            lambda t, i: [(key_root, t, 1.0, 45)] if i % 2 == 0 else [],
            # Pattern 2: Root and fifth
            lambda t, i: [(key_root, t, 0.5, 45), (key_root + 7, t + 0.5, 0.5, 40)] if i % 2 == 0 else [],
            # Pattern 3: Walking bass
            lambda t, i: [(key_root + scale[i % len(scale)], t, 0.5, 45)] if i % 2 == 0 else [],
            # Pattern 4: Octave jumps
            lambda t, i: [(key_root, t, 0.5, 45), (key_root - 12, t + 0.5, 0.5, 40)] if i % 2 == 0 else [],
            # Pattern 5: Root and third
            lambda t, i: [(key_root, t, 0.5, 45), (key_root + 4, t + 0.5, 0.5, 40)] if i % 2 == 0 else []
        ]
        
        verse_patterns = [
            # Pattern 1: Walking bass
            lambda t, i: [(key_root + scale[i % len(scale)], t, 0.5, 60)] if i % 2 == 0 else [],
            # Pattern 2: Root and fifth
            lambda t, i: [(key_root, t, 0.5, 60), (key_root + 7, t + 0.5, 0.5, 55)] if i % 2 == 0 else [],
            # Pattern 3: Root and third
            lambda t, i: [(key_root, t, 0.5, 60), (key_root + 4, t + 0.5, 0.5, 55)] if i % 2 == 0 else [],
            # Pattern 4: Alternating root and fifth
            lambda t, i: [(key_root, t, 0.25, 60), (key_root + 7, t + 0.25, 0.25, 55)] if i % 2 == 0 else [],
            # Pattern 5: Root and octave
            lambda t, i: [(key_root, t, 0.5, 60), (key_root - 12, t + 0.5, 0.5, 55)] if i % 2 == 0 else []
        ]
        
        chorus_patterns = [
            # Pattern 1: Strong root notes
            lambda t, i: [(key_root, t, 0.5, 75)] if i % 2 == 0 else [],
            # Pattern 2: Root and fifth with octave
            lambda t, i: [(key_root, t, 0.5, 75), (key_root + 7, t + 0.5, 0.5, 70), (key_root - 12, t + 0.5, 0.5, 65)] if i % 2 == 0 else [],
            # Pattern 3: Walking bass with octave
            lambda t, i: [(key_root + scale[i % len(scale)], t, 0.5, 75), (key_root + scale[i % len(scale)] - 12, t + 0.5, 0.5, 70)] if i % 2 == 0 else [],
            # Pattern 4: Root and third with fifth
            lambda t, i: [(key_root, t, 0.5, 75), (key_root + 4, t + 0.25, 0.25, 70), (key_root + 7, t + 0.5, 0.5, 70)] if i % 2 == 0 else [],
            # Pattern 5: Octave jumps with fifth
            lambda t, i: [(key_root, t, 0.25, 75), (key_root - 12, t + 0.25, 0.25, 70), (key_root + 7, t + 0.5, 0.5, 70)] if i % 2 == 0 else []
        ]
        
        bridge_patterns = [
            # Pattern 1: Chromatic walking bass
            lambda t, i: [(key_root + scale[i % len(scale)], t, 0.5, 65)] if i % 2 == 0 else [],
            # Pattern 2: Root and fifth with chromatic movement
            lambda t, i: [(key_root, t, 0.5, 65), (key_root + 7, t + 0.5, 0.5, 60)] if i % 2 == 0 else [],
            # Pattern 3: Root and third with chromatic movement
            lambda t, i: [(key_root, t, 0.5, 65), (key_root + 4, t + 0.5, 0.5, 60)] if i % 2 == 0 else [],
            # Pattern 4: Alternating root and fifth with chromatic movement
            lambda t, i: [(key_root, t, 0.25, 65), (key_root + 7, t + 0.25, 0.25, 60)] if i % 2 == 0 else [],
            # Pattern 5: Root and octave with chromatic movement
            lambda t, i: [(key_root, t, 0.5, 65), (key_root - 12, t + 0.5, 0.5, 60)] if i % 2 == 0 else []
        ]
        
        outro_patterns = [
            # Pattern 1: Fading root notes
            lambda t, i: [(key_root, t, 1.0, max(30, 70 - (i // 4) * 10))] if i % 4 == 0 else [],
            # Pattern 2: Dwindling walking bass
